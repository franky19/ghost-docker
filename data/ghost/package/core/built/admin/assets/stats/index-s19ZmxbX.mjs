import { f as W, j as e, S as we, c as k, u as ae, a as Q, b as T, d as E, e as te, g as x, h as J, i as P, R as ye, k as X, l as Z, m as ke, n as A, o as _e, p as L, s as B } from "./index-DbGvSTMe.mjs";
import { B as z, X as Ce, H as re, C as ze, L as Me, a as R, b as D, c as H, d as V, e as F, S as y, f as Ae, g as Te, G as $, U as ie, M as Y, h as Le, E as q, F as ne, i as $e, j as We, k as O, l as Ee, m as K, K as Re, n as De, o as He, p as Ve, I as Fe, q as Ie, r as S, s as ee, t as Be, u as Oe, v as Ge, w as Ue, x as Pe, y as Ye, z as Ke, N as Qe, D as qe, A as Je, J as Xe } from "./stats-CJ7fhUyT.mjs";
import { R as Ze, T as Se, P as es, C as le, a as oe, D as ce, O as de, g as ss } from "./audience-select-DNAWmT7R.mjs";
import { u as as } from "./use-growth-stats-DzO7zEy4.mjs";
function ts(s) {
...
function me(s) {
  var t, a;
  const n = s.status === "published", r = s.status === "sent", o = !!s.email, m = ((t = s.email) == null ? void 0 : t.status) !== "failed", l = typeof ((a = s.email) == null ? void 0 : a.email_count) == "number" && s.email.email_count > 0;
  return (r || n) && o && (m || l);
}
function ls(s, t) {
...
const he = W(({ className: s, children: t, ...a }, n) => /* @__PURE__ */ e.jsx(ds, { children: /* @__PURE__ */ e.jsxs("div", { className: we, children: [
  /* @__PURE__ */ e.jsx(ue, {}),
  /* @__PURE__ */ e.jsx(
    le,
    {
...
const ms = ({
  ...
  const [v, p] = ae(!1), N = async () => {
    try {
      await navigator.clipboard.writeText(t), p(!0), setTimeout(() => p(!1), 2e3);
    } catch {
    }
  }, f = encodeURIComponent(m), C = encodeURIComponent(t), w = encodeURIComponent(`${m} ${t}`);
  return /* @__PURE__ */ e.jsxs(os, { ...j, children: [
    /* @__PURE__ */ e.jsx(cs, { className: "cursor-pointer", asChild: !0, children: b }),
    /* @__PURE__ */ e.jsxs(he, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      /* @__PURE__ */ e.jsx("div", { className: "sticky top-0 ml-auto size-0", children: /* @__PURE__ */ e.jsx(z, { className: "absolute -right-5 -top-5 cursor-pointer p-2 text-muted-foreground hover:text-foreground [&_svg]:!size-6", size: "lg", variant: "link", onClick: d, children: /* @__PURE__ */ e.jsx(Ce, { size: 24, strokeWidth: 1 }) }) }),
      /* @__PURE__ */ e.jsxs(xe, { className: "relative -mt-5", children: [
        ...
        r && /* @__PURE__ */ e.jsx(fe, { className: "mb-0 pb-0 pt-1 text-lg text-foreground", children: r })
      ] }),
      /* @__PURE__ */ e.jsxs("a", { className: "flex flex-col items-stretch overflow-hidden rounded-md border transition-all hover:border-muted-foreground/40", href: t, rel: "noopener noreferrer", target: "_blank", children: [
        o && /* @__PURE__ */ e.jsx("div", { className: "aspect-video bg-cover bg-center", style: {
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "p-6 pt-5", children: [
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "mt-2 flex items-start gap-2", children: [
            ...
            /* @__PURE__ */ e.jsxs("div", { className: "flex gap-1", children: [
              /* @__PURE__ */ e.jsx("strong", { children: c }),
      ...
      /* @__PURE__ */ e.jsx(pe, { className: "justify-between gap-6", children: s ? /* @__PURE__ */ e.jsx(z, { className: "cursor-pointer", type: "submit", onClick: d, children: "Close" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://twitter.com/intent/tweet?text=${f}%0A${C}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsx("svg", { "aria-hidden": "true", viewBox: "0 0 24 24", children: /* @__PURE__ */ e.jsx("path", { className: "social-x_svg__x", d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" }) }) }),
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://threads.net/intent/post?text=${w}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 18 18", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://www.facebook.com/sharer/sharer.php?u=${C}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 40 40", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `http://www.linkedin.com/shareArticle?mini=true&title=${f}&url=${C}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 16 16", children: [
        ...
        /* @__PURE__ */ e.jsxs(
          z,
          {
            ...
            onClick: N,
            children: [
              v ? /* @__PURE__ */ e.jsx(ze, {}) : /* @__PURE__ */ e.jsx(Me, {}),
              v ? "Copied!" : "Copy link"
            ]
          }
        )
  ...
  var j, v, p;
  const a = Q(), [n, r] = ae(!1), { site: o, settings: m } = T(), { appSettings: l } = E(), { emailTrackClicks: u, emailTrackOpens: c } = (l == null ? void 0 : l.analytics) || {}, i = o.title || String(((j = m.find((N) => N.key === "title")) == null ? void 0 : j.value) || "Ghost Site"), d = s ? ls(s, {
    membersTrackSources: l == null ? void 0 : l.analytics.membersTrackSources
  }) : null, b = "group mr-2 flex flex-col gap-1.5 hover:cursor-pointer";
  return /* @__PURE__ */ e.jsxs(R, { className: "group/card bg-gradient-to-tr from-muted/40 to-muted/0 to-50%", "data-testid": "latest-post", children: [
    ...
    /* @__PURE__ */ e.jsxs(F, { className: "flex flex-col gap-6 px-0 lg:flex-row xl:grid xl:grid-cols-3", children: [
      ...
      !t && s && d ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col items-start justify-center self-stretch", children: [
            ...
            /* @__PURE__ */ e.jsxs("div", { className: "mt-6 flex items-center gap-2", children: [
              !s.email_only && /* @__PURE__ */ e.jsx(
                ms,
                {
                  author: ((v = s.authors) == null ? void 0 : v.map((N) => N.name).join(", ")) || "",
                  description: "",
                  faviconURL: o.icon || "",
                  ...
                  onClose: () => r(!1),
                  onOpenChange: r,
                  children: /* @__PURE__ */ e.jsxs(z, { onClick: () => r(!0), children: [
                    /* @__PURE__ */ e.jsx(Ae, {}),
                    " Share post"
                  ] })
                }
        ...
        /* @__PURE__ */ e.jsx("div", { className: "-ml-4 flex w-full flex-col items-stretch gap-2 pr-6 text-sm xl:h-full xl:max-w-none", children: /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-2 gap-6 pl-10 lg:border-l xl:h-full", children: [
          d.showWebMetrics && (l == null ? void 0 : l.analytics.webAnalytics) && /* @__PURE__ */ e.jsxs("div", { className: b, "data-testid": "latest-post-visitors", onClick: () => {
          ...
          d.showMemberGrowth && /* @__PURE__ */ e.jsxs("div", { className: k(
            b,
            ...
            d.showEmailMetrics && (!d.showWebMetrics || !(l != null && l.analytics.webAnalytics)) && "row-[2/3] col-[1/2]"
          ...
          d.showEmailMetrics && s.email && /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
            c && /* @__PURE__ */ e.jsxs("div", { className: b, onClick: () => {
            ...
            u && /* @__PURE__ */ e.jsxs("div", { className: b, onClick: () => {
              a(`/posts/analytics/${s.id}/newsletter`, { crossApp: !0 });
            }, children: [
              /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-1.5 font-medium text-muted-foreground transition-all group-hover:text-foreground", children: [
              ...
              /* @__PURE__ */ e.jsx("span", { className: "text-[2.2rem] font-semibold leading-none tracking-tighter", children: s.email.email_count && ((p = s.count) != null && p.clicks) ? J((s.count.clicks || 0) / s.email.email_count) : "0%" })
            ] })
          ] })
        ] }) })
      ] }) : !t && /* @__PURE__ */ e.jsx(
        q,
        {
          actions: /* @__PURE__ */ e.jsx(z, { variant: "secondary", onClick: () => {
  ...
  return {
    isLimited: (a) => {
      ...
      return (r = n == null ? void 0 : n.hostSettings) != null && r.limits && a === "limitAnalytics" ? ((o = n.hostSettings.limits.limitAnalytics) == null ? void 0 : o.disabled) === !0 : !1;
    }
  };
}, G = ({
  // linkto,
  ...
  const { range: i } = T(), d = t && He[t], b = ye.useMemo(() => {
    if (!r || r === "empty" || i === X.allTime.value || !o)
      return "";
    const j = r === "up" ? "up" : r === "down" ? "down" : "at", p = K(i).replace("in the ", "").replace(/^\(|\)$/g, "");
    return r === "same" ? /* @__PURE__ */ e.jsxs("span", { children: [
      "You're trending at the same level as ",
      /* @__PURE__ */ e.jsx("span", { className: "font-semibold", children: m }),
      " compared to the ",
      /* @__PURE__ */ e.jsx("span", { className: "font-semibold", children: p })
      ...
      " from ",
      /* @__PURE__ */ e.jsx("span", { className: "font-semibold", children: l }),
      " compared to the ",
      p
    ] });
  }, [r, o, l, m, i]);
  return /* @__PURE__ */ e.jsxs(R, { className: "group", "data-testid": s, children: [
    ...
    /* @__PURE__ */ e.jsxs(Re, { className: "relative flex grow flex-row items-start justify-between gap-5 border-none pb-2 xl:pb-4", children: [
      /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col gap-1.5 border-none pb-0", children: [
        /* @__PURE__ */ e.jsxs(De, { className: c && "transition-all group-hover:text-foreground", children: [
          n && /* @__PURE__ */ e.jsx("span", { className: "inline-block size-2 rounded-full opacity-50", style: { backgroundColor: n } }),
          d && /* @__PURE__ */ e.jsx(d, { size: 16, strokeWidth: 1.5 }),
          s
        ] }),
        /* @__PURE__ */ e.jsx(
          Ve,
          {
            diffDirection: i === X.allTime.value ? "hidden" : r,
            diffTooltip: b,
            diffValue: o,
            value: m
          }
      ...
      c && /* @__PURE__ */ e.jsx(z, { className: "absolute right-6 translate-x-10 opacity-0 transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100", size: "sm", variant: "outline", onClick: c, children: "View more" })
    ] }),
    /* @__PURE__ */ e.jsx(F, { children: u })
  ] });
}, ps = ({
  kpiValues: s,
  visitorsChartData: t,
  ...
  const u = Q(), { range: c } = T(), { appSettings: i } = E(), b = xs().isLimited("limitAnalytics"), j = "-mb-3 h-[10vw] max-h-[200px] min-h-[100px] hover:!cursor-pointer";
  if (l)
  ...
  const v = i == null ? void 0 : i.analytics.webAnalytics, p = b && !v, N = !0, f = i == null ? void 0 : i.paidMembersEnabled, C = [v, p, N, f].filter(Boolean).length;
  let w = "lg:grid-cols-3";
  C === 2 ? w = "lg:grid-cols-2" : C === 1 && (w = "lg:grid-cols-1");
  const I = `flex flex-col lg:grid ${w} gap-6`;
  return /* @__PURE__ */ e.jsxs("div", { className: I, children: [
    ...
    p && /* @__PURE__ */ e.jsxs(R, { children: [
      ...
      /* @__PURE__ */ e.jsx(F, { className: "flex h-full items-center justify-center p-6", children: /* @__PURE__ */ e.jsx(
        q,
        {
          actions: /* @__PURE__ */ e.jsx(z, { variant: "outline", onClick: () => u("/pro", { crossApp: !0 }), children: "Upgrade now" }),
          className: "py-10",
    ...
    /* @__PURE__ */ e.jsx(
      G,
      {
        ...
        diffDirection: n.directions.total,
        diffValue: n.percentChanges.total,
        formattedValue: x(n.totalMembers),
        iconName: "User",
        linkto: "/analytics/growth/",
        title: "Members",
        trendingFromValue: `${x(r[0].value)}`,
        onClick: () => {
          u("/analytics/growth/?tab=total-members");
        },
        children: /* @__PURE__ */ e.jsx(
          O,
          {
    ...
    f && /* @__PURE__ */ e.jsx(
      G,
      {
        ...
        diffDirection: n.directions.mrr,
        diffValue: n.percentChanges.mrr,
        formattedValue: `${m}${x(P(n.mrr))}`,
        iconName: "Coins",
        linkto: "/analytics/growth/",
        title: "MRR",
        trendingFromValue: `${m}${x(o[0].value)}`,
        onClick: () => {
          u("/analytics/growth/?tab=mrr");
        },
        children: /* @__PURE__ */ e.jsx(
          O,
          {
  ...
  className: s
}) => /* @__PURE__ */ e.jsx("div", { className: k("rounded-sm bg-muted dark:bg-[#36373a] flex flex-col items-center justify-center gap-1 p-6", s), children: /* @__PURE__ */ e.jsx(Fe, { className: "text-muted-foreground/50", size: 18, strokeWidth: 1.5 }) }), U = ({
  className: s,
  metrics: t,
  title: a
  ...
  /* @__PURE__ */ e.jsx("div", { className: "flex flex-col gap-1.5", children: t == null ? void 0 : t.map((n) => /* @__PURE__ */ e.jsxs("div", { className: "flex items-center justify-between gap-5", children: [
    /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-1.5 whitespace-nowrap", children: [
      n.icon,
      n.label
    ] }),
    /* @__PURE__ */ e.jsx("span", { className: "font-mono", children: n.metric })
  ] }, n.label)) })
] }) }), fs = ({
  topPostsData: s,
  isLoading: t
  ...
  var c;
  const a = Q(), { range: n } = T(), { appSettings: r } = E(), o = r == null ? void 0 : r.analytics.webAnalytics, m = r == null ? void 0 : r.analytics.emailTrackClicks, l = r == null ? void 0 : r.analytics.emailTrackOpens, u = "flex items-center justify-end gap-1 rounded-md px-2 py-1 font-mono text-gray-800 hover:bg-muted-foreground/10 group-hover:text-foreground";
  return /* @__PURE__ */ e.jsxs(R, { className: "group/card w-full lg:col-span-2", "data-testid": "top-posts-card", children: [
    ...
    /* @__PURE__ */ e.jsx(F, { children: t ? /* @__PURE__ */ e.jsx(Ie, { className: "mt-6" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      (c = s == null ? void 0 : s.stats) == null ? void 0 : c.map((i) => /* @__PURE__ */ e.jsxs("div", { className: 'group relative flex w-full items-start justify-between gap-5 border-t border-border/50 py-4 before:absolute before:-inset-x-4 before:inset-y-0 before:z-0 before:hidden before:rounded-md before:bg-accent before:opacity-80 before:content-[""] first:!border-border hover:cursor-pointer hover:border-transparent hover:before:block md:items-center dark:before:bg-accent/50 [&+div]:hover:border-transparent', children: [
        /* @__PURE__ */ e.jsxs("div", { className: "z-10 flex min-w-[160px] grow items-start gap-4 md:items-center lg:min-w-[320px]", onClick: () => {
          a(`/posts/analytics/${i.post_id}`, { crossApp: !0 });
        }, children: [
          i.feature_image ? /* @__PURE__ */ e.jsx("div", { className: "hidden aspect-[16/10] w-[80px] shrink-0 rounded-sm bg-cover bg-center sm:!visible sm:!block lg:w-[100px]", style: {
            backgroundImage: `url(${i.feature_image})`
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ e.jsx("span", { className: "line-clamp-2 text-lg font-semibold leading-[1.35em]", children: i.title }),
            ...
            /* @__PURE__ */ e.jsx("span", { className: "text-sm text-muted-foreground", children: ts(i) })
          ] })
        ] }),
        /* @__PURE__ */ e.jsxs("div", { className: "z-10 flex flex-col items-end justify-center gap-0.5 text-sm md:flex-row md:items-center md:justify-end md:gap-3", children: [
          o && /* @__PURE__ */ e.jsxs("div", { className: "group/tooltip relative flex w-[66px] lg:w-[92px]", "data-testid": "statistics-visitors", onClick: (d) => {
            d.stopPropagation(), a(`/posts/analytics/${i.post_id}/web`, { crossApp: !0 });
          }, children: [
            /* @__PURE__ */ e.jsx(
              U,
              {
          ...
          i.sent_count !== null && /* @__PURE__ */ e.jsxs("div", { className: "group/tooltip relative flex w-[66px] lg:w-[92px]", onClick: (d) => {
            d.stopPropagation(), a(`/posts/analytics/${i.post_id}/newsletter`, { crossApp: !0 });
          }, children: [
            /* @__PURE__ */ e.jsx(
              U,
              {
                className: `${r != null && r.analytics.membersTrackSources ? "" : "left-auto right-0 translate-x-0"}`,
                metrics: [
                  // Always show sent
                  {
                    icon: /* @__PURE__ */ e.jsx(S, { className: "shrink-0 text-muted-foreground", size: 16, strokeWidth: 1.5 }),
                    label: "Sent",
                    metric: x(i.sent_count || 0)
                  },
                  ...
                  ...m ? [{
                    ...
                    label: "Clicks",
                    metric: x(i.clicked_count || 0)
                  }] : []
                ],
                title: "Newsletter performance"
              }
            ),
            /* @__PURE__ */ e.jsx("div", { className: u, children: l ? /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
              /* @__PURE__ */ e.jsx(Y, { className: "text-muted-foreground group-hover:text-foreground", size: 16, strokeWidth: 1.5 }),
              i.open_rate ? `${Math.round(i.open_rate)}%` : "0%"
              ...
              i.click_rate ? `${Math.round(i.click_rate)}%` : "0%"
            ] }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
              /* @__PURE__ */ e.jsx(S, { className: "text-muted-foreground group-hover:text-foreground", size: 16, strokeWidth: 1.5 }),
              Z(i.sent_count || 0)
            ] }) })
          ] }),
          (r == null ? void 0 : r.analytics.membersTrackSources) && /* @__PURE__ */ e.jsxs("div", { className: "group/tooltip relative flex w-[66px] lg:w-[92px]", "data-testid": "statistics-members", onClick: (d) => {
            d.stopPropagation(), a(`/posts/analytics/${i.post_id}/growth`, { crossApp: !0 });
          }, children: [
            /* @__PURE__ */ e.jsx(
              U,
              {
  ...
  }), a = s, n = Ge((a == null ? void 0 : a.id) || "", {
    enabled: !!(a != null && a.id)
  }), { data: r, isLoading: o } = n;
  return {
    data: A(() => {
      var u;
      if (!a)
        return null;
      const l = ((u = r == null ? void 0 : r.stats) == null ? void 0 : u[0]) || {
        id: a.id,
  ...
  s
), href: n, rel: "noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-6", children: [
  r,
  ...
  const { appSettings: s } = E(), { statsConfig: t, isLoading: a, range: n, audience: r } = T(), { startDate: o, endDate: m, timezone: l } = _e(n), { isLoading: u, chartData: c, totals: i, currencySymbol: d } = as(n), { data: b, isLoading: j } = vs(), { data: v, isLoading: p } = Ue({
    searchParams: {
      date_from: L(o),
      date_to: L(m),
      limit: "5",
    ...
    var g;
    return (g = B(f || [], n, "visits", "sum")) == null ? void 0 : g.map((_) => {
      const M = Number(_.visits), h = isNaN(M) ? 0 : M;
      return {
        date: String(_.date),
        value: h,
        formattedValue: x(h),
    ...
    if (!w || w.length === 0)
      return g;
    const _ = w.map((h) => h.value).filter((h) => h >= 0);
    return _.length === 0 ? g : [0, Math.max(..._) || g[1]];
  }, [w]), be = A(() => {
    if (!c || c.length === 0)
      return [];
    let g = [];
    return g = B(c, n, "value", "exact"), g.map((h) => ({
      date: h.date,
      value: h.free + h.paid,
    ...
    if (!(s != null && s.paidMembersEnabled) || !c || c.length === 0)
      return [];
    let g = [];
    return g = B(c, n, "mrr", "exact"), g.map((h) => ({
      date: h.date,
      value: P(h.mrr),
  ...
  return /* @__PURE__ */ e.jsxs(Ye, { children: [
    ...
    /* @__PURE__ */ e.jsxs(Je, { isLoading: Ne, loadingComponent: /* @__PURE__ */ e.jsx(e.Fragment, {}), children: [
      /* @__PURE__ */ e.jsx(
        ps,
        {
          currencySymbol: d,
...
//# sourceMappingURL=index-s19ZmxbX.mjs.map
